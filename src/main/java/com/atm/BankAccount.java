 ...
 * <p>
 * This abstract class defines the template methods for deposit and withdrawal
 * operations,
 * along with hook methods for customizing account-specific parameters such as
 * limits and commission fees.
 * Concrete subclasses (e.g., GoldAccount, PlatinumAccount, StudentAccount)
 * inherit from this class
 * and override these hook methods to provide specific behaviors and account
 * logics.
 * </p>
 * <p>
 * <strong>Modification History:</strong><br>
 * Gur modified the entire class in Task Week 4 (version 1.0.1), made it
 * abstract, set up inheritance for other
 * account classes, and implemented different account logics for deposit,
 * withdrawal, limits, and commissions.
 * <br>
 * Bora modified the class in Task Week 5 (version 3.0.1), changed the account
 * number and password to String to preserve leading zeros.
 * <br>
 * Bora modified the class in Task Week 5 (version 3.0.2), added setAccPasswd
 * method to support password changing functionality.
 * </p>
 */
public abstract class BankAccount {
    ...
    // Low Balance Treshold
    private static final double LOW_BALANCE_THRESHOLD = 10.0;

    /**
     * Constructs a bank account with the specified account number, password, and
     * initial balance.
     *
     ...
     *                  <p>
     *                  Week 5 - Bora - Version 3.0.1: Modified parameter types from
     *                  int to String for leading zero support.
     *                  </p>
     */
     ...
     * <li>The withdrawal must not cause the balance to drop below the overdraft
     * limit.</li>
     * </ul>
     ...
     * <p>
     * The method checks that the deposit amount is positive and does not exceed the
     * deposit limit.
     ...
     * <p>
     * This is a "hook" method that can be overridden by subclasses to customize the
     * withdrawal limit.
     * </p>
     *
     ...
     * <p>
     * This is a "hook" method that can be overridden by subclasses to define how
     * far into negative balance
     ...
     * <p>
     * This is a "hook" method that can be overridden by subclasses to provide
     * specific commission fees.
     * </p>
     *
     ...
     *         <p>
     *         Week 5 - Bora - Version 3.0.1: Changed return type from int to String
    ...
    /**
     * Checks if the balance is below the low balance threshold and appends a
     * warning to lastMessage.
     * @Author Mertcan Week 8
     */
    private void checkLowBalance() {
        if (balance < LOW_BALANCE_THRESHOLD) {
            lastMessage = lastMessage + "\n\nWARNING: LOW BALANCE ALERT!\nYour balance (£" + balance + ") is below the threshold of £" + LOW_BALANCE_THRESHOLD + ".\nPlease deposit funds to avoid potential issues.";
        }
    }
}
